...
Class Repair{
    ...
    //     $query="SELECT users.uid,users.username,users.phone, users.address, repair_service.repairNote, repair_service.replyNote FROM repair_service INNER JOIN users ON users.salt=repair_service.user ORDER BY repair_service.rid DESC";
    //     $this->time = "（所有记录，含过期）";
    //     $this->showResult($query,"select sum(repairNote), sum(replyNote) from repair_service INNER JOIN users ON users.salt=repair_service.user");
    // }
