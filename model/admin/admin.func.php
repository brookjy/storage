...
class Admin{
    ...
    public function admin_login(){
		...
		if($check_user){
			echo "<script type=\"text/javascript\">alert('欢 迎 回 来!');window.location.replace(\"../admin/admin.php\");</script>";
			setcookie("admin", $this->username, time()+86400);
    ...
    public function validateAdmin(){
		global $mysqli;
		$admin_matching_query = "SELECT aid FROM admin WHERE username = '$this->username' AND password = '$this->username'";
